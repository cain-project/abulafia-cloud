				...
				<ul class="nav navbar-nav">
                    ...
                    <?php if($_SESSION['mod_autoparco'] && $anag->isAutoparco($_SESSION['loginid'])) { ?>
                        <li class="dropdown <?php if($_GET['corpus'] == 'cert' OR $_GET['corpus']=='cert-anag') { echo ' active'; }?>">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="?corpus=autoparco-search-veicoli"><i class="fa fa-car fa-fw"></i> Veicoli</a></li>
						...
						<ul class="dropdown-menu">
							...
							<?php 
								if ($_SESSION['auth'] >= 90) {
                                    ...
                                    <?php if($anag->isAdmin($_SESSION['loginid'])) { ?><li><a href="login0.php?corpus=autoparco-tipologie"><i class="fa fa-car fa-fw"></i> Tipologie veicoli</a></li> <?php } ?>
